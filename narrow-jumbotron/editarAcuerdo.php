                       ...
                       <form method="POST" action="">
                                <div class="card">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" id="disabled-input" name="disabled-input" disabled=""placeholder="<?php echo $_SESSION['num_sesion']; ?>" class="form-control">
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" id="disabled-input" name="disabled-input" disabled=""placeholder="<?php echo $_SESSION['fecha_creacion']; ?>" class="form-control">
                                        </div>
                                        </div>
