...
if (isset($_POST['send_a'])) {
    ...
    $titulo_acuerdo = $_POST['titulo_acuerdo'];
    $departamento = $_POST['departamento'];
    $descripcion = $_POST['descripcion'];
    $archivo_name = $_FILES['archivo']['name'];
    $archivo_tmp = $_FILES['archivo']['tmp_name'];
    $fecha_acuerdo = $_POST['fecha_acuerdo'];
    ...
    if ($obj->Normal_Query("INSERT INTO acuerdos (titulo_acuerdo, descripcion, archivo, fecha_acuerdo, fecha_finiquito) 
      VALUES (?,?,?,?,?)", [$titulo_acuerdo, $descripcion, $archivo_name, $fecha_acuerdo, $fecha_finiquito])) {
        $obj->Create_Session("titulo_acuerdo", $titulo_acuerdo);
        // $obj->Create_Session("titulo_sesion", $titulo_sesion);
        // $obj->Create_Session("departamento", $departamento);
        $obj->Create_Session("fecha_acuerdo", $fecha_acuerdo);
        $obj->Create_Session("fecha_finiquito", $fecha_finiquito);
        $obj->Create_Session("archivo", $archivo_name);
    }

    if ($obj->Normal_Query("INSERT INTO sesiones (titulo_sesion, fecha_sesion) 
      VALUES (?, ?)", [$titulo_sesion, $fecha_acuerdo])) {
        $obj->Create_Session("titulo_sesion", $titulo_sesion);
        $obj->Create_Session("fecha_sesion", $fecha_acuerdo);
    }

    /*if ($obj->Normal_Query("INSERT INTO departamentos (nombre) 
      VALUES (?)", [$departamento])) {
        $obj->Create_Session("departamento", $departamento);
    }*/

    /*if ($obj->Normal_Query("INSERT INTO acuerdo_departamento (nombre) 
      VALUES (?)", [$departamento])) {
        $obj->Create_Session("departamento", $departamento);
    }*/
}
                                ...
                                <div class="card-body">
                                    ...
                                    <form form method="POST" action="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="cc-payment" class="control-label mb-1">Título de sesión</label>
                                            <input id="cc-pament" name="titulo_sesion" type="text" class="form-control" aria-required="true" aria-invalid="false" >
                                        </div>
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">Título de acuerdo</label>
                                            <input id="cc-name" name="titulo_acuerdo" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-pament" name="fecha_acuerdo" type="date" class="form-control" aria-required="true" aria-invalid="false" >
